...
\begin{document}
	...
	\begin{theorem}
		...
		\begin{equation}
			\mathcal{O}_{n}(a, b, c, d, \dots, z) \approx \int_{\alpha}^{\beta} \frac{\mathcal{X}_t}{\mathcal{X}_n} d\bigl(\delta(\operatorname{Ratio}(t) \cdot \mathcal{X}_p)\bigr).
		\end{equation}
	...
	\begin{equation}
		\label{ineq:1}
		\mathcal{O}_{n}(a, b, c, d, \dots, z)^{-1} < \Bigl| \int_{\alpha}^{\beta} \frac{\mathcal{X}_t}{\mathcal{X}_n} d\Bigl(\delta\Bigl(\operatorname{Ratio}(t) \cdot \mathcal{X}_p\Bigr)\Bigr) \Bigr| < \mathcal{O}_{n}(a, b, c, d, \dots, z).
	\end{equation}
	...
	\end{equation}
	For variables $t$ and $i$ in $\mathbb{R}.$ That satifies the following condition of not being equal to zero and $t, \, i$ being between $[0, 1]$.
	\begin{remark}
