...
\begin{document}
	...
	\begin{equation}
		\label{ineq:1}
		\mathcal{O}_{n}(a, b, c, d, \dots, z)^{-1} < \pm \int_{\alpha}^{\beta} \frac{\mathcal{X}_t}{\mathcal{X}_n} d\bigl(\delta(\operatorname{Ratio}(t) \cdot \mathcal{X}_p)\bigr) < \mathcal{O}_{n}(a, b, c, d, \dots, z).
	\end{equation}
